...
export class WalletController {
    ...
    @Put('/update')
    async updateWallet(@Res() res, @Query('walletID') walletID, @Body() createWalletDTO: CreateWalletDTO) {
        const wallet = await this.walletService.updateWallet(walletID, createWalletDTO);
